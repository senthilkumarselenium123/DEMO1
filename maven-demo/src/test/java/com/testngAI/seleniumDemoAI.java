...
//		driver.get("file:///C:/Users/infok/OneDrive/Desktop/seleniumloginAI.html");
//
//
...
//		Thread.sleep(1000);
//		driver.findElement(By.xpath(Locators.textBoxXpath("Input_typetext"))).sendKeys("UserName");
//		driver.findElement(By.xpath(Locators.textBoxXpath("Input_typepassword"))).sendKeys("Password");
